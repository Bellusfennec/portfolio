        ...
        <div className={style.experienceSkill}>
          <div className={style.experience}>
            ...
            <TagP>
              ...
              делал сайты для друзей и знакомых, вносил изминения на сайте
              крупной компании и параллельно много самостоятельно обучался.
              <br />
              <br />Я создаю адаптивные веб-сайты, быстрые, простые в
              использовании и созданы с учетом лучших практик. Основная область
              моих знаний - вёрстка, использую HTML, CSS, JS, создание небольших
              и средних веб-приложений.
            </TagP>
          </div>
